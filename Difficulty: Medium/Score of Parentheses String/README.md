<h2><a href="https://www.geeksforgeeks.org/problems/score-of-parentheses-string/1">Score of Parentheses String</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a string <strong>s</strong>&nbsp;consisting of balanced parentheses, calculate the <strong>score</strong> of the string based on the following rules:</span></p>
<ul>
